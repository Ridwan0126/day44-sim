...
class ListMahasiswa extends Component {
  ...
  render() {
    const { dataMhsBaru, dataEditMhs, setDetailMhs, setProfileDetailMhs } =
      this.props;
    return (
      <Mahasiswa
        dataMhsBaru={dataMhsBaru}
        setDetailMhs={setDetailMhs}
        setProfileDetailMhs={setProfileDetailMhs}
        dataEditMhs={dataEditMhs}
      />
    );
  }
}
