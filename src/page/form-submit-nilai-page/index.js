    ...
    return (
      <form onSubmit={this.updateNilai}>
        ...
        <table className="customers-list">
          ...
          <tbody>{this.renderPageSubmit()}</tbody>
        </table>
      </form>
    );
  }
...
const mapDispatchToProps = (dispatch) => ({
  ...
  editNilai: (mhsKrsDetail) =>
    dispatch({ type: "EDIT_Nilai", payload: { mhsKrsDetail } }),
});
