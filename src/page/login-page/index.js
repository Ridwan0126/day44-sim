...
class LoginPage extends Component {
  ...
  onSubmitHandler = (e) => {
    ...
    if (
      this.state.username !== "Psycho2601@gmail.com" &&
      this.state.password !== "Psycho123"
    )
      return Swal.fire({
        icon: "error",
  ...
  render() {
    if (this.props.isLogedIn) return <Redirect to="/list-mahasiswa" />;

    return (
      <div className="bg">
        <h1 className="titleRegister1" align="center">
          UNIVERSITY OF WIBU
        </h1>
        <h2 className="titleRegister" align="center">
          Login
        </h2>
        <form className="bgform">
          ...
          <div className="formInput">
            ...
            <button class="submitButton" onClick={this.onSubmitHandler}>
              Sign in
            </button>
          </div>
        </form>
