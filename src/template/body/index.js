...
class Body extends Component {
  constructor(props) {
    ...
    this.state = {
      listSks: [
        ...
        {
          idsks: 4,
          matkul: "Ilmu Nutrisi Ternak Dasar",
          jmlsks: "4",
          idjurusan: "PETERNAKAN",
          dosen: "",
        },
        {
          idsks: 5,
          matkul: "Anatomi Ternak",
          jmlsks: "3",
          idjurusan: "PETERNAKAN",
          dosen: "",
        },
        ...
        {
          idsks: 7,
          matkul: "Biologi Seluler",
          jmlsks: "4",
          idjurusan: "KEDOKTERAN",
          dosen: "",
        },
        {
          idsks: 8,
  ...
  addNewListPenerimaanHandler = (newMahasiswa) => {
    ...
    const idNew =
      listMhs.length === 0 ? 1 : Math.max(...listMhs.map((mhs) => mhs.id)) + 1;
    ...
    return (
      <Switch>
        ...
        <Route path="/penerimaan">
          <ListPenerimaanPage listPenerimaan={this.state.listPenerimaan} />
        </Route>
        ...
        <Route path="/detail-profile-mahasiswa">
          <DetailProfile mhsProfileDetail={this.state.mhsProfileDetail} />
        </Route>
        <Route path="/list-sks">
