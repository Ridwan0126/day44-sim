...
class TabelSks extends Component {
  ...
  editHandler = (id) => {
    ...
    if (checkFilter.length > 0) return alert("Save terlebih dahulu!!");
          ...
          <tr key={index}>
            ...
            <td>
              <input
                name="inputIdjurusan"
                type="text"
                value={this.state.inputIdjurusan}
                onChange={this.onChangeHandler}
              />
            </td>
            <td>
